if(!instance_exists(obj_player) || fx_undefined()){
	exit;
}
...
if(in_water){
	...
	distort2_str += (DISTORT2_STR_WATER - distort2_str) * TRANSITION_MULT;
	...
	distort2_str += (DISTORT2_STR_AIR - distort2_str) * TRANSITION_MULT;
